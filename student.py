...
class Student:
    def __init__(self,root):
        ...
        #Fist Image
        img=Image.open(r"C:\Users\PERSONAL\Code\python web framework\ndkc_face_recognition_system\college_images\face-recognition.png")
        ...
        #Second Image
        img1=Image.open(r"C:\Users\PERSONAL\Code\python web framework\ndkc_face_recognition_system\college_images\facialrecognition.png")
        ...
        #bg Image
        img3=Image.open(r"C:\Users\PERSONAL\Code\python web framework\ndkc_face_recognition_system\college_images\bg1.jpg")
        img3=img3.resize((1530,740),Image.ANTIALIAS)
        self.photoimg3=ImageTk.PhotoImage(img3)
        
        bg_img=Label(self.root,image=self.photoimg3)
        bg_img.place(x=0,y=100,width=1530,height=740) 
        
        title_lbl = Label(bg_img, text="STUDENT MANAGEMENT SYSTEM", font=("times new roman", 20, "bold"), bg="white", fg="darkgreen")
        ...
        img_left=Image.open(r"C:\Users\PERSONAL\Code\python web framework\ndkc_face_recognition_system\college_images\AdobeStock_303989091.jpeg")
        ...
        current_course_frame.place(x=5,y=100,width=595,height=110)
        ...
        dep_combo["values"]=("Select Department","Engineering", "Technology")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","CPE","CE","ECE","IT","CS")
        ...
        # Semester
        course_label = Label(current_course_frame,text="Semester", font = ("times new roman", 11, "bold"),bg="white")
        course_label.grid(row=1,column=2,padx=10,sticky=W)
        
        course_combo=ttk.Combobox(current_course_frame,textvariable=self.var_semester, font = ("times new roman", 11, "bold"),state="readonly", width=20)
        course_combo["values"]=("Select Semester","1st Semester","2nd Semester")
        course_combo.current(0)
        ...
        class_student_frame.place(x=5,y=210,width=595,height=265)
        ...
        class_div_label.grid(row=1,column=0,padx=4,pady=3,sticky=W)
        
        class_div_combo=ttk.Combobox(class_student_frame,textvariable=self.var_div, font = ("times new roman", 11, "bold"),state="readonly", width=18)
        class_div_combo["values"]=("A","B", "C")
        class_div_combo.current(0)
        class_div_combo.grid(row=1,column=1,padx=4,pady=3,sticky=W)
        ...
        gender_combo.grid(row=2,column=1,padx=4,pady=3,sticky=W)
        ...
        address_entry.grid(row=4,column=1,padx=4,pady=3,sticky=W)
        
        # Professor
        professor_label = Label(class_student_frame,text="Professor:", font = ("times new roman", 11, "bold"),bg="white")
        professor_label.grid(row=4,column=2,padx=4,pady=3,sticky=W)
        
        professor_entry =ttk.Entry(class_student_frame,textvariable=self.var_professor,width=20, font = ("times new roman", 11, "bold"))
        professor_entry.grid(row=4,column=3,padx=4,pady=3,sticky=W)
        ...
        btn_frame.place(x=0,y=170,width=590,height=35)
        
        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=16, font = ("times new roman", 11, "bold"),bg="blue",fg="white")
        ...
        btn_frame1.place(x=1,y=208,width=590,height=35)
        ...
        img_right=Image.open(r"C:\Users\PERSONAL\Code\python web framework\ndkc_face_recognition_system\college_images\student.jpg")
        ...
        Search_frame.place(x=5,y=100,width=595,height=65)
        ...
        table_frame.place(x=5,y=170,width=595,height=320) 
        
        scroll_x=ttk.Scrollbar(table_frame, orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(table_frame, orient=VERTICAL)
        
        self.student_table=ttk.Treeview(table_frame, columns=("dep", "course", "year", "sem", "id", "name", "div", "roll", "gender", "dob","email", "phone","address", "professor", "photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
